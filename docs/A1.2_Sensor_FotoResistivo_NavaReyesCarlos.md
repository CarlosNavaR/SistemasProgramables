...
8. Calculate the accuracy of the resulting voltages between the theoric and measured for each of the conditions, consider incnluding in this section an explanation for the procedure used for the calculation of the theoric values.
